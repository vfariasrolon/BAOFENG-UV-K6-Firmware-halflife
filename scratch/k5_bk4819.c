...
#define _SET_SCN() GPIO_SetOutputPin(GPIO_PIN_BK4819_SCN)
#define _SET_SCL() GPIO_SetOutputPin(GPIO_PIN_BK4819_SCL)
#define _SET_SDA() GPIO_SetOutputPin(GPIO_PIN_BK4819_SDA)

#define _RESET_SCN() GPIO_ResetOutputPin(GPIO_PIN_BK4819_SCN)
#define _RESET_SCL() GPIO_ResetOutputPin(GPIO_PIN_BK4819_SCL)
#define _RESET_SDA() GPIO_ResetOutputPin(GPIO_PIN_BK4819_SDA)

#define _GET_SDA() GPIO_GetInputPin(GPIO_PIN_BK4819_SDA)
...
static uint16_t BK4819_ReadU16(void)
{
    ...
    GPIO_SetPinDir(GPIO_PIN_BK4819_SDA, GPIO_DIR_INPUT);
    ...
    GPIO_SetPinDir(GPIO_PIN_BK4819_SDA, GPIO_DIR_OUTPUT);
...
void BK4819_SetCDCSSCodeWord(uint32_t CodeWord)
{
    ...
    BK4819_WriteRegister(BK4819_REG_51, 0 | BK4819_REG_51_ENABLE_CxCSS | BK4819_REG_51_GPIO6_PIN2_NORMAL | BK4819_REG_51_TX_CDCSS_POSITIVE | BK4819_REG_51_MODE_CDCSS | BK4819_REG_51_CDCSS_23_BIT | BK4819_REG_51_1050HZ_NO_DETECTION | BK4819_REG_51_AUTO_CDCSS_BW_ENABLE | BK4819_REG_51_AUTO_CTCSS_BW_ENABLE | (51U << BK4819_REG_51_SHIFT_CxCSS_TX_GAIN1));

    // CTC1 Frequency Control Word = 2775
    BK4819_WriteRegister(BK4819_REG_07, 0 | BK4819_REG_07_MODE_CTC1 | (2775U << BK4819_REG_07_SHIFT_FREQUENCY));
...
void BK4819_SetCTCSSFrequency(uint32_t FreqControlWord)
{
    ...
    BK4819_WriteRegister(BK4819_REG_07, 0 | BK4819_REG_07_MODE_CTC1 | ((FreqControlWord * 2065) / 1000) << BK4819_REG_07_SHIFT_FREQUENCY);
}
...
void BK4819_EnableDTMF(void)
{
    ...
    BK4819_WriteRegister(BK4819_REG_24, 0 | (1U << BK4819_REG_24_SHIFT_UNKNOWN_15) | (24 << BK4819_REG_24_SHIFT_THRESHOLD) | (1U << BK4819_REG_24_SHIFT_UNKNOWN_6) | BK4819_REG_24_ENABLE | BK4819_REG_24_SELECT_DTMF | (14U << BK4819_REG_24_SHIFT_MAX_SYMBOLS));
}
...
void BK4819_PlayTone(uint16_t Frequency, bool bTuningGainSwitch)
{
    ...
    BK4819_WriteRegister(BK4819_REG_30, 0);
    BK4819_WriteRegister(BK4819_REG_30, 0 | BK4819_REG_30_ENABLE_AF_DAC | BK4819_REG_30_ENABLE_DISC_MODE | BK4819_REG_30_ENABLE_TX_DSP);
    ;
...
void BK4819_TurnsOffTones_TurnsOnRX(void)
{
    ...
    BK4819_ExitTxMute();
    BK4819_WriteRegister(BK4819_REG_30, 0);
    BK4819_WriteRegister(BK4819_REG_30, 0 | BK4819_REG_30_ENABLE_VCO_CALIB | BK4819_REG_30_ENABLE_RX_LINK | BK4819_REG_30_ENABLE_AF_DAC | BK4819_REG_30_ENABLE_DISC_MODE | BK4819_REG_30_ENABLE_PLL_VCO | BK4819_REG_30_ENABLE_RX_DSP);
}
...
void BK4819_EnterDTMF_TX(bool bLocalLoopback)
{
    ...
    BK4819_WriteRegister(BK4819_REG_70, 0 | BK4819_REG_70_MASK_ENABLE_TONE1 | (83 << BK4819_REG_70_SHIFT_TONE1_TUNING_GAIN) | BK4819_REG_70_MASK_ENABLE_TONE2 | (83 << BK4819_REG_70_SHIFT_TONE2_TUNING_GAIN));
...
{
    BK4819_WriteRegister(BK4819_REG_30, 0 | BK4819_REG_30_ENABLE_VCO_CALIB | BK4819_REG_30_ENABLE_UNKNOWN | BK4819_REG_30_DISABLE_RX_LINK | BK4819_REG_30_ENABLE_AF_DAC | BK4819_REG_30_ENABLE_DISC_MODE | BK4819_REG_30_ENABLE_PLL_VCO | BK4819_REG_30_ENABLE_PA_GAIN | BK4819_REG_30_DISABLE_MIC_ADC | BK4819_REG_30_ENABLE_TX_DSP | BK4819_REG_30_DISABLE_RX_DSP);
}
...
void BK4819_SetScanFrequency(uint32_t Frequency)
{
    ...
    BK4819_WriteRegister(BK4819_REG_51, 0 | BK4819_REG_51_DISABLE_CxCSS | BK4819_REG_51_GPIO6_PIN2_NORMAL | BK4819_REG_51_TX_CDCSS_POSITIVE | BK4819_REG_51_MODE_CDCSS | BK4819_REG_51_CDCSS_23_BIT | BK4819_REG_51_1050HZ_NO_DETECTION | BK4819_REG_51_AUTO_CDCSS_BW_DISABLE | BK4819_REG_51_AUTO_CTCSS_BW_DISABLE);
    BK4819_RX_TurnOn();
}
