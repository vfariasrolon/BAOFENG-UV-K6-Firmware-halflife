...
# Add uartSendChar declaration if not present
if "extern void uartSendChar(unsigned char ch);" not in content:
    content = content.replace('#include "DevFD6818.h"', '#include "DevFD6818.h"\nextern void uartSendChar(unsigned char ch);')
