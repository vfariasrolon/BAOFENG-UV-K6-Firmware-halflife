...
echo -e "\n${YELLOW}Si prefieres dar permisos al puerto de forma inmediata${NC}"
echo -e "${YELLOW}y sin reiniciar la sesión, escribe este comando:${NC}"
echo -e "${BLUE}    sudo chmod 666 /dev/ttyUSB0${NC}"
